...
Some examples of the assignments were: a demand forecasting problem, a [data-driven inventory management](assets/pdf/sca_class/assignment.pdf) setting, a [tanker-loading and transporting problem](assets/pdf/sca_class/midterm_2.pdf) and a [cloud-computing for AI allocation problem](assets/pdf/sca_class/final.pdf).
...
Fortunately, this was not the case! In fact, there is a clear pattern where the students have meaningful differences with respect to the AI. As a first example, for the [tanker-loading and transporting problem](assets/pdf/sca_class/midterm_2.pdf), which is a difficult TSP with additional Dynamic Programming dynamics. See the distribution of scores:
